    ...
    fetchExamWithQuestions(examId)
      .then(async (data) => {
        ...
        setExam({
          ...
          allow_review: Boolean(data.exam.allow_review),
          lock_completed_sections: Boolean(data.exam.lock_completed_sections),
          show_result: Boolean(data.exam.allow_student_view),
          show_question_review: Boolean(data.exam.allow_question_review),
          show_correct_answers: Boolean(data.exam.allow_show_correct_answers),
