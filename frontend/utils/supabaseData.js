...
export async function createExam(examPayload, questions) {
  ...
  const examRow = {
    ...
    allow_review: Boolean(examPayload.allow_review),
    allow_student_view: Boolean(examPayload.show_result),
    allow_question_review:
      Boolean(examPayload.show_result) && Boolean(examPayload.show_question_review),
    allow_show_correct_answers: Boolean(examPayload.show_correct_answers),
...
export async function updateExam(examId, exam, questions) {
  ...
  const examUpdate = {
    ...
    allow_student_view: Boolean(exam.show_result),
    allow_question_review:
      Boolean(exam.show_result) && Boolean(exam.show_question_review),
    allow_show_correct_answers: Boolean(exam.show_correct_answers),
    duration_value: durationFields.duration_value,
    duration_unit: durationFields.duration_unit,
